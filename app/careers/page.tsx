      ...
      <div className="container-responsive py-4 sm:py-6">
        <Card className="card-enhanced text-center">
          <CardHeader className="border-b p-4 sm:p-6">
            <CardTitle className="text-lg sm:text-xl">Careers at MindEase</CardTitle>
          </CardHeader>
          <CardContent className="p-4 sm:p-6 space-y-4">
            <p className="text-gray-700 leading-relaxed">Thank you for your interest in joining the MindEase team!</p>
            <p className="text-gray-700 leading-relaxed text-2xl font-bold text-emerald-600">Coming Soon!</p>
            <p className="text-gray-600">
              We are currently building our core team and will be posting exciting career opportunities soon. Please
              check back later for updates.
            </p>
            <p className="text-sm text-gray-500">
              In the meantime, you can learn more about our mission on the{" "}
              <a href="/about" className="text-emerald-600 hover:underline" onClick={handleBackToHome}>
                About Us
              </a>{" "}
              page.
            </p>
